  ...
  return (
    <div className="w-full px-4 md:w-1/2 xl:w-1/4">
      <div className="group relative mb-10 overflow-hidden rounded-xl border border-[#EDEDED] bg-white px-6 py-11 text-center duration-200 hover:-translate-y-1">
        <div className="text-dark mx-auto mb-8 flex h-20 w-20 items-center justify-center rounded-full border border-[#EDEDED] text-3xl font-semibold shadow-sm group-hover:border-primary group-hover:bg-primary group-hover:text-white">
          {number}
        </div>
